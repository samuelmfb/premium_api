...
configured on the Customer machine.   The application then specifies the name
...
is configured on the Customer, a basic DSN-based connection looks like::
...
can help make this easier::
    ...
    from sqlalchemy.engine import URL
    connection_string = "DRIVER={SQL Server Native Customer 10.0};SERVER=dagger;DATABASE=test;UID=user;PWD=password"
