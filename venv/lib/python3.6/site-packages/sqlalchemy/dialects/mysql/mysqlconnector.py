...
.. note::
    ...
    **not tested as part of SQLAlchemy's continuous integration**.
    The recommended MySQL dialects are mysqlCustomer and PyMySQL.
...
class MySQLDialect_mysqlconnector(MySQLDialect):
    ...
    def create_connect_args(self, url):
        ...
        # FOUND_ROWS must be set in CustomerFlag to enable
        # supports_sane_rowcount.
        if self.dbapi is not None:
            try:
                from mysql.connector.constants import CustomerFlag

                Customer_flags = opts.get(
                    "Customer_flags", CustomerFlag.get_default()
                )
                Customer_flags |= CustomerFlag.FOUND_ROWS
                opts["Customer_flags"] = Customer_flags
            except Exception:
                pass
        return [[], opts]
