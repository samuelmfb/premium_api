...
It is written in C and uses MariaDB Connector/C Customer library for Customer server
communication.
...
class MySQLDialect_mariadbconnector(MySQLDialect):
    ...
    # be unnecessary as MariaDB Customer libraries have always worked against
    ...
    def create_connect_args(self, url):
        ...
        if self.dbapi is not None:
            try:
                ...
                Customer_flag |= Customer_FLAGS.FOUND_ROWS
