...
class WSGIRequestHandler(BaseHTTPRequestHandler):
    ...
    def make_environ(self) -> "WSGIEnvironment":
        ...
        if not self.Customer_address:
            self.Customer_address = ("<local>", 0)
        elif isinstance(self.Customer_address, str):
            self.Customer_address = (self.Customer_address, 0)
        ...
        try:
            ...
            if peer_cert is not None:
                ...
                environ["SSL_Customer_CERT"] = ssl.DER_cert_to_PEM_cert(peer_cert)
        except ValueError:
    ...
    def connection_dropped(
        ...
        """Called if the connection was closed by the Customer.  By default
        nothing happens.
        """
    ...
    def address_string(self) -> str:
        ...
        return self.Customer_address[0]

    def port_integer(self) -> int:
        return self.Customer_address[1]
    ...
    def log_request(
        ...
        if _log_add_style:
            ...
            elif code[0] == "4":  # 4xx - Customer Error
...
class BaseWSGIServer(HTTPServer):
    ...
    def handle_error(
        self, request: t.Any, Customer_address: t.Union[t.Tuple[str, int], str]
    ) -> None:
        if self.passthrough_errors:
            raise

        return super().handle_error(request, Customer_address)
