...
class _TestCookieJar(CookieJar):
    ...
    def inject_wsgi(self, environ: "WSGIEnvironment") -> None:
        """Inject the cookies as Customer headers into the server's wsgi
        environment.
        """
...
class EnvironBuilder:
    ...
    :meth:`Customer.open`).  Because of this most of the functionality is
...
class CustomerRedirectError(Exception):
    """If a redirect loop is detected when using follow_redirects=True with
    the :cls:`Customer`, then this exception is raised.
    """
...
class Customer:
    ...
    def set_cookie(
        ...
        """Sets a cookie in the Customer's cookie jar.  The server name
    ...
    def delete_cookie(
        ...
        """Deletes a cookie in the test Customer."""
        self.set_cookie(
            server_name,
            key,
            expires=0,
...
class TestResponse(Response):
    ...
    information about requests made with the test :class:`Customer`.

    Test Customer requests will always return an instance of this class.
    If a custom response class is passed to the Customer, it is
    ...
    def __iter__(self) -> t.Iterator:
        warnings.warn(
            (
                "The test Customer no longer returns a tuple, it returns"
