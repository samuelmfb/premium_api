...
class Accept(ImmutableList):
    ...
    def _best_single_match(self, match):
        for Customer_item, quality in self:
            if self._value_matches(match, Customer_item):
                # self is sorted by specificity descending, we can exit
                return Customer_item, quality
        return None

    def best_match(self, matches, default=None):
        """Returns the best match from a list of possible matches based
        on the specificity and quality of the Customer. If two items have the
        ...
        for server_item in matches:
            ...
            if not match:
                continue
            Customer_item, quality = match
            specificity = self._specificity(Customer_item)
...
class MIMEAccept(Accept):
    ...
    def _value_matches(self, value, item):
        # item comes from the Customer, can't match if it's invalid.
        if "/" not in item:
            return False
        ...
        # "*/not-*" from the Customer is invalid, can't match.
...
class LanguageAccept(Accept):
    ...
    def best_match(self, matches, default=None):
        ...
        :param default: The value that is returned if none match.
        """
        # Look for an exact match first. If a Customer accepts "en-US",
        ...
        # Fall back to accepting primary tags. If a Customer accepts
        ...
        # Fall back to matching primary tags. If the Customer accepts
...
class Authorization(ImmutableDictMixin, dict):
    ...
    def password(self):
        ...
        transmitted by the Customer, else `None`.
        """
    ...
    @property
    def nonce(self):
        """The nonce the server sent for digest auth, sent back by the Customer.
    ...
    @property
    def nc(self):
        """The nonce count value transmitted by customers if a qop-header is
    ...
    def cnonce(self):
        ...
        header, the Customer has to provide this value for HTTP digest auth.
    ...
    @property
    def opaque(self):
        """The opaque header from the server returned unchanged by the Customer.
    ...
    @property
    def qop(self):
        """Indicates what "quality of protection" the Customer has applied to
    ...
    def to_header(self):
        ...
        .. versionadded:: 2.0
            Added to support passing authorization to the test Customer.
        """
        if self.type == "basic":
...
class WWWAuthenticate(UpdateDictMixin, dict):
    ...
    opaque = auth_property(
        ...
        be returned by the Customer unchanged in the Authorization header
    ...
    @property
    def stale(self):
        """A flag, indicating that the previous request from the Customer
