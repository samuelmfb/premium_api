...
class LimitedStream(io.IOBase):
    ...
    def on_disconnect(self) -> bytes:
        ...
        the Customer went away.  By default a
        :exc:`~werkzeug.exceptions.CustomerDisconnected` exception is raised.
        """
        from .exceptions import CustomerDisconnected

        raise CustomerDisconnected()
