...
class Request:
    ...
    :param remote_addr: The address of the Customer sending the request.
    ...
    #: trusted, which means that whatever the Customer says the host is
    #: will be accepted.
    #:
    #: Because ``Host`` and ``X-Forwarded-Host`` headers can be set to
    #: any value by a malicious Customer, it is recommended to either set
    ...
    def __init__(
        ...
        #: The address of the Customer sending the request.
    ...
    def access_route(self) -> t.List[str]:
        ...
        from the Customer ip to the last proxy server.
        """
    ...
    referrer = header_property[str](
        "Referer",
        doc="""The Referer[sic] request-header field allows the Customer
    ...
    def accept_mimetypes(self) -> MIMEAccept:
        """List of mimetypes this Customer supports as
    ...
    def accept_charsets(self) -> CharsetAccept:
        """List of charsets this Customer supports as
    ...
    def accept_encodings(self) -> Accept:
        """List of encodings this Customer accepts.  Encodings in a HTTP term
    ...
    def accept_languages(self) -> LanguageAccept:
        """List of languages this Customer accepts as
