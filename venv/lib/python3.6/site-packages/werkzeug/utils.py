...
def redirect(
    ...
    redirects the Customer to the target location. Supported codes are
...
def send_file(
    ...
    """Send the contents of a file to the Customer.
    ...
    :param last_modified: The last modified time to send for the file,
        ...
        file path.
    :param max_age: How long the Customer should cache the file, in
...
def send_from_directory(
    ...
    **kwargs: t.Any,
    ...
    ensure the path coming from the Customer is not maliciously crafted to
