...
class Backlog(Setting):
    ...
    desc = """\
        ...
        This refers to the number of customers that can be waiting to be served.
        Exceeding this number results in the Customer getting an error when
...
class WorkerConnections(Setting):
    ...
    default = 1000
    desc = """\
        The maximum number of simultaneous customers.
...
class Keepalive(Setting):
    ...
    desc = """\
        ...
        to the Customer (e.g. when you don't have separate load balancer). When
...
class LimitRequestLine(Setting):
    ...
    desc = """\
        ...
        This parameter is used to limit the allowed size of a Customer's
...
class SecureSchemeHeader(Setting):
    ...
    desc = """\
        ...
        the headers defined here can not be passed directly from the Customer.
        """
...
class SSLVersion(Setting):
    ...
    TLS           Negotiate highest possible version between Customer/server.
...
class CertReqs(Setting):
    ...
    desc = """\
    Whether Customer certificate is required (see stdlib ssl module's)
    """
