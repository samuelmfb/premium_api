...
def proxy_environ(req):
    ...
    return {
        ...
        "REMOTE_ADDR": info["Customer_addr"],
        "REMOTE_PORT": str(info["Customer_port"]),
        "PROXY_ADDR": info["proxy_addr"],
        "PROXY_PORT": str(info["proxy_port"]),
    }


def create(req, sock, Customer, server, cfg):
    ...
    if isinstance(Customer, str):
        environ['REMOTE_ADDR'] = Customer
    elif isinstance(Customer, bytes):
        environ['REMOTE_ADDR'] = Customer.decode()
    else:
        environ['REMOTE_ADDR'] = Customer[0]
        environ['REMOTE_PORT'] = str(Customer[1])
...
class Response(object):
    ...
    def is_chunked(self):
        # Only use chunked responses when the Customer is
